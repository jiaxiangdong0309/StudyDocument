...
| 性能优化 | [Performance/1-基础篇](./Performance/1-基础篇.md) | 渲染机制、Profiler 实战、memo/useMemo/useCallback 正确用法、状态设计优化、Context 性能 |
| 性能优化 | [Performance/2-进阶篇](./Performance/2-进阶篇.md) | 虚拟列表、代码分割、React 18 并发特性、Bundle 分析优化、网络层优化、真实项目案例 |
